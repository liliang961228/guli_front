      ...
      <section class="c-sort-box">
        ...
        <div class="mt40">
          ...
          <article class="comm-course-list">
            <ul class="of" id="bna">
              <li v-for="(record,index) in data.records" :key="index">
                <div class="cc-l-wrap">
                  ...
                  <h3 class="hLh30 txtOf mt10">
                    <a :href="'/course/'+record.id" :title="record.title" class="course-title fsize18 c-333">{{record.title}}</a>
                  </h3>
...
export default {
  ...
  asyncData({ params, error }) {
    return Course.getFrontCoursePageLists(1,8)
      .then(response => {
   ...
   methods: {
    gotoPage(page){
        Course.getFrontCoursePageLists(page, 8)
          .then(response => {
