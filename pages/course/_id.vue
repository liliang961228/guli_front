  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="#" title class="c-999 fsize14">{{courseInfo.subjectLevelOne}}</a>
        \
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt">
              <a href="#plays" title="立即观看" class="comm-btn c-btn-3">立即观看</a>
            </section>
          </section>
        </aside>
                  ...
                  <section class="mt20">
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul id="plays">
                          <!-- 文件目录 -->
                          <li v-for="(chapter,index) in chapterVideoList" :key="index" class="lh-menu-stair">
                            <a href="javascript: void(0)" :title="chapter.title" class="current-1">
                              <em class="lh-menu-i-1 icon18 mr10"></em>{{chapter.title}}
                            </a>
                            <ol class="lh-menu-ol" style="display: block;">
                              <li v-for="(video,index) in chapter.videoDtos" :key="index" class="lh-menu-second ml30">
                                <a
...
export default {
  asyncData({ params, error }) {
    return Course.getCourseWebDtoByCourseId(params.id)
      .then(response => {
        return {
          courseInfo:response.data.data.courseWebDto,
          chapterVideoList:response.data.data.chapterList
        }
      })
  }
